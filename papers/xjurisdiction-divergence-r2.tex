...
%% Override acmart manuscript's 1.5× line spacing.
%% \setstretch (setspace) updates the internal linespread factor so that
%% \normalsize re-applications keep single spacing.  We then sync acmart's
%% guard (\ACM@origbaselinestretch) to the new value so AtEndDocument passes.
\setstretch{1.0}
\makeatletter
