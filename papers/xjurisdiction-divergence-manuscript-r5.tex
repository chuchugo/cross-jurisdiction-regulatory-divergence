%% Version: r5 (arXiv-preprint ratio reduced to <=20%; RAG-faithfulness preprints replaced by Yoran et al., ICLR 2024)
%%
%% RegDivergence-101
...
full text~\citep{yoran2024robust}. This comparison is a within-model
